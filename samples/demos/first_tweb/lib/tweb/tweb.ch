...
#xcommand ENDFORM <oForm> [ START <fOnInit> ] RETURN =>  return <oForm>:Activate( <fOnInit> )
...
#xcommand SMALL [ ID <cId> ] [ LABEL <cLabel> ] [ GRID <nGrid> ] [ CLASS <cClass> ] OF <oForm> => <oForm>:Small( <cId>, <cLabel>, <nGrid>, [<cClass>] )
...
#xcommand NAV [<oNav>] [ ID <cId> ] [ TITLE <cTitle> ] [ LOGO <cLogo> [ WIDTH <nWidth>]  [HEIGHT <nHeight> ] ] OF <oWeb> ;	
=> ;
	[<oNav> := ] TWebNav():New( <oWeb>, [<cId>], [<cTitle>], [<cLogo>], [<nWidth>], [<nHeight>] )

#xcommand MENUITEM <cItem> ROUTE <cRoute> OF <oNav>  => <oNav>:AddMenuItem( <cItem>, <cRoute> )
