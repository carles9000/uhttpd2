...
static function Del( oDom )
	...
	oDom:SetTable( 'structure', 'deleteRow', nil, 'Delete row?' )				
...
static function InitTable( oDom )
	...
	oDom:TableInit( 'structure', aColumns, nil, aConfig )	
...
static function TablesDir( oDom )
	...
	oDom:TableInit( 'tablesdir', aColumns, aData )	

	oDom:SetData( { 'dbfs' => aDir } )
